...
@interface NSString (BKReplyInput)
@end

@implementation NSString (BKReplyInput)
...
@implementation BKReplyInputView
...
- (void)composeView
{
    ...
    sendButton.layer.borderColor = [UIColor colorWithRed:(50 / 255.0) green:(205 / 255.0) blue:(229 / 255.0) alpha:1.0].CGColor;
    sendButton.layer.cornerRadius = 3;
    [sendButton setTitleColor:[UIColor colorWithRed:(50 / 255.0) green:(205 / 255.0) blue:(229 / 255.0) alpha:1.0] forState:0];
...
{
    [_delegate replyInputWithText:textView.text appendTag:_replyTag];
    [self disappear];
