...
- (UIImage *)aspectRatioImage{
    return _aspectRatioImage ? _aspectRatioImage : [UIImage imageWithCGImage:[self.asset aspectRatioThumbnail]];
}

- (void)thumbImageCallBack:(callBackImage)callBack{
    UIImage *thumbImage = _thumbImage ? _thumbImage : self.aspectRatioImage;
...
- (UIImage *)originImage{
    return _originImage ? _originImage : [UIImage imageWithCGImage:[[self.asset defaultRepresentation] fullScreenImage]];
}
